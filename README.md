...
- [ ] Explain what a token is used for.
        A token is used to authenticate a web session after credentials have been provided.

- [ ] What steps can you take in your web apps to keep your data secure?
        Place data that needs to be secure behind protected routes that must be authenticated to reach.

- [ ] Describe how web servers work.
        Web servers hold data and return it when a request for data has been made and authenticated.
